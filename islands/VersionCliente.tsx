...
export const VersionCliente: FunctionComponent<
    { data: cluster_cliente; activos: boolean; signal: Signal<number> }
> = ({ data, activos, signal }) => {
    ...
    const [Telefono, settel] = useState<number | undefined>(
        newdata.v_actual!.Telefono,
    );
    const [Correp, setcorrep] = useState<string | undefined>(
        newdata.v_actual!.Correo,
    );
    const [Direcion, setdir] = useState<string | undefined>(
        newdata.v_actual!.Direccion,
    );
    const [Empresa, setem] = useState<number>(newdata.v_actual!.Empresa);
    const [Cp, setcp] = useState<number | undefined>(newdata.v_actual!.CP);
    const [activo, setact] = useState<number | undefined>(
        newdata.v_actual!.Activo,
    );
    ...
    if (activos || activo) {
        if (enable) {
            ...
            return (
                <li class={clas}>
                    <p>
                        ID: {newdata.v_actual!.id_cliente &&
                            newdata.v_actual!.id_cliente}
                    </p>
                    <p>
                        Nombre:{" "}
                        {newdata.v_actual!.Nombre && newdata.v_actual!.Nombre}
                    </p>
                    <p>
                        Apellidos: {newdata.v_actual!.Apellidos &&
                            newdata.v_actual!.Apellidos}
                    </p>
                    <p>DNI: {newdata.v_actual!.DNI && newdata.v_actual!.DNI}</p>
                    <p>
                        Telefono: {newdata.v_actual!.Telefono &&
                            newdata.v_actual!.Telefono !== 1 &&
                            newdata.v_actual!.Telefono}
                    </p>
                    <p>
                        Correo: {(newdata.v_actual!.Correo !== "null" &&
                            newdata.v_actual!.Correo) &&
                            newdata.v_actual!.Correo}
                    </p>
                    <p>
                        Direccion: {(newdata.v_actual!.Direccion !== "null" &&
                            newdata.v_actual!.Direccion) &&
                            newdata.v_actual!.Direccion}
                    </p>
                    ...
                    <p>
                        CP:{" "}
                        {newdata.v_actual!.CP && newdata.v_actual!.CP !== 1 &&
                            newdata.v_actual!.CP}
                    </p>
                    <label for="Version:">Version:</label>

                    <select
                        value={JSON.stringify(newdata.v_actual)}
                        label="Version:"
                        onChange={(e) => {
                            change_v(e.currentTarget.value);
                        }}
                    >
                        <option value={JSON.stringify(newdata.v_actual!)}>
                            V-{"Last"}: {newdata.v_actual!.Fecha_mod}
                        </option>
                        {data.v_anteriores.length > 0 &&
                            data.v_anteriores.map((v: Cliente) => {
                                return (
                    ...
                    <p>
                        Alta: {newdata.v_actual!.Fecha_Alta &&
                            newdata.v_actual!.Fecha_Alta}
                    </p>
                    <p>
                        Modificacion: {newdata.v_actual!.Fecha_mod !== "0" &&
                            newdata.v_actual!.Fecha_mod}
                    </p>
                    <p>
                        Baja: {newdata.v_actual!.Fecha_Baja !== "0" &&
                            newdata.v_actual!.Fecha_Baja}
                    </p>
                ...
                <li class={clas}>
                    ...
                    <p>
                        ...
                        <input
                            ...
                            value={Telefono}
                            onBlur={(e) => {
                                settel(parseInt(e.currentTarget.value));
                            }}
                        />
                    </p>
                    <p>
                        ...
                        <input
                            ...
                            value={Correp}
                            onBlur={(e) => {
                                setcorrep(e.currentTarget.value);
                            }}
                        />
                    </p>
                    <p>
                    ...
                    <p>
                        ...
                        <input
                            ...
                            value={Cp}
                            onBlur={(e) => {
                                setcp(parseInt(e.currentTarget.value));
                            }}
                        />
                    </p>
